    ...
    public partial class Schema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClosedTimeDto", x => x.Cid);
                });
            migrationBuilder.CreateTable(
                name: "Game",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerDto", x => x.Pid);
                });
            migrationBuilder.CreateTable(
                name: "Stock",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockDto", x => x.Sid);
                });
            migrationBuilder.CreateTable(
                name: "Transaction",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionDto", x => x.Tid);
                });
            migrationBuilder.CreateTable(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("ClosedTime");
